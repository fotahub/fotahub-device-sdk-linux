...
1. Start the Visual Studio Code and open (`File > Folder...`) the `Thing Shadow` example included in the FotaHub Device SDK for Linux and Raspberry Pi (`<device-sdk-root>/examples/thingshadow`).
